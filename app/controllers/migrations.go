...
func InitDB() {
	...
	demoUser := &models.Tenant{0, "Demo User", "demo", "demo", bcryptPassword}
...
func (c *MigrationsController) Begin() r.Result {
	txn, err := Dbm.Begin()
	if err != nil {
		panic(err)
	}
...
func (c *MigrationsController) Commit() r.Result {
	if c.Txn == nil {
		return nil
	}
...
func (c *MigrationsController) Rollback() r.Result {
	if c.Txn == nil {
		return nil
	}
